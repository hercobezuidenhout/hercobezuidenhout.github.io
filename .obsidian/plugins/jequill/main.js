...
__export(main_exports, {
  default: () => JequillPlugin
});
module.exports = __toCommonJS(main_exports);
var import_obsidian4 = require("obsidian");

// src/ui/workspace.ts
var STYLE_ID = "jekyll-minimal-workspace";
var registerMinimalWorkspaceStyles = () => {
...
var JequillSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    new import_obsidian.Setting(containerEl).setName("Enable minimal workspace").addToggle(
      (toggle) => toggle.setValue(this.plugin.settings.enableMinimalWorkspace).onChange(async (value) => {
...
process_fn = function() {
  ...
  for (const root5 of roots) {
    try {
      __privateMethod(this, _traverse, traverse_fn).call(this, root5, effects, render_effects);
    } catch (e) {
      reset_all(root5);
    ...
    if (others.length === 0) {
      ...
      if (__privateGet(batch, _roots).length > 0 && !__privateGet(batch, _decrement_queued)) {
        ...
        for (var root5 of __privateGet(batch, _roots)) {
          __privateMethod(_a5 = batch, _traverse, traverse_fn).call(_a5, root5, [], []);
        }
...
var root = from_html(`<button type="button" class="post svelte-ylyn4m"><span class="title svelte-ylyn4m"> </span> <span class="excerpt svelte-ylyn4m"> </span> <span class="meta svelte-ylyn4m"> </span></button>`);
var $$css = {
  hash: "svelte-ylyn4m",
  code: ".post.svelte-ylyn4m {all:unset;padding:12px 16px;margin-bottom:4px;cursor:pointer;border-radius:4px;transition:background-color 0.15s ease;display:flex;flex-direction:column;}.post.svelte-ylyn4m:hover {background:var(--background-modifier-hover);}.post.svelte-ylyn4m .title:where(.svelte-ylyn4m) {font-size:1.05em;font-weight:500;color:var(--text-normal);margin-bottom:6px;line-height:1.4;}.post.svelte-ylyn4m .excerpt:where(.svelte-ylyn4m) {font-size:0.9em;color:var(--text-muted);margin-bottom:6px;line-height:1.5;}.post.svelte-ylyn4m .meta:where(.svelte-ylyn4m) {font-size:0.85em;color:var(--text-faint);}"
};
function Post($$anchor, $$props) {
  ...
  template_effect(
    ($0, $1) => {
      ...
      set_text(text_1, $$props.post.excerpt);
      set_text(text_2, `${$0 != null ? $0 : ""} \xB7 ${$1 != null ? $1 : ""}`);
    },
    [
      () => formatDate($$props.post.date),
      () => getReadingTime($$props.post.wordCount)
    ]
  );
  delegated("click", button, function(...$$args) {
    var _a5;
    (_a5 = $$props.onClick) == null ? void 0 : _a5.apply(this, $$args);
  });
...
// src/components/PostsSectionHeader.svelte
var root2 = from_html(`<div class="svelte-1kkbfap"><h4 class="svelte-1kkbfap"> </h4> <span class="svelte-1kkbfap"> </span></div>`);
var $$css2 = {
  hash: "svelte-1kkbfap",
  code: "div.svelte-1kkbfap {display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;padding-bottom:8px;border-bottom:1px solid var(--background-modifier-border);}h4.svelte-1kkbfap {font-size:0.85em;font-weight:600;text-transform:uppercase;letter-spacing:0.05em;color:var(--text-muted);}span.svelte-1kkbfap {font-size:0.85em;color:var(--text-muted);}"
};
function PostsSectionHeader($$anchor, $$props) {
...
var root3 = from_html(`<div><!> <div class="post-list svelte-1rh81q7"></div></div>`);
var root_1 = from_html(`<div class="jequill-header svelte-1rh81q7"><h2 class="svelte-1rh81q7">Writing</h2> <button class="mod-cta svelte-1rh81q7">New post</button></div> <!> <!>`, 1);
var $$css3 = {
  hash: "svelte-1rh81q7",
  code: ".jequill-header.svelte-1rh81q7 {display:flex;justify-content:space-between;align-items:center;margin-bottom:24px;}.jequill-header.svelte-1rh81q7 h2:where(.svelte-1rh81q7) {margin:0;color:var(--text-normal);}button.svelte-1rh81q7 {cursor:pointer;}.post-list.svelte-1rh81q7 {display:flex;flex-direction:column;align-items:stretch;}"
};
function Posts($$anchor, $$props) {
  push($$props, true);
  append_styles($$anchor, $$css3);
  let drafts = $$props.posts.filter((post) => post.isDraft);
  let published = $$props.posts.filter((post) => !post.isDraft);
  var fragment = root_1();
  ...
  var node = sibling(div, 2);
  {
    var consequent = ($$anchor2) => {
      ...
      each(div_2, 21, () => drafts, index, ($$anchor3, post) => {
        Post($$anchor3, {
          get post() {
            return get2(post);
          },
          onClick: () => $$props.onPostClick(get2(post).file)
        });
      });
      reset(div_2);
      reset(div_1);
  ...
  var node_2 = sibling(node, 2);
  {
    var consequent_1 = ($$anchor2) => {
      ...
      each(div_4, 21, () => published, index, ($$anchor3, post) => {
        Post($$anchor3, {
          get post() {
            return get2(post);
          },
  ...
  delegated("click", button, function(...$$args) {
    var _a5;
    (_a5 = $$props.onNewPostClick) == null ? void 0 : _a5.apply(this, $$args);
  });
...
// src/views/PostsView.ts
var VIEW_TYPE_POSTS = "jequill-posts-view";
var PostsView = class extends import_obsidian2.ItemView {
  constructor(leaf) {
    super(leaf);
    this.posts = [];
  ...
  for (const line of lines) {
    ...
    if (match) {
      ...
      if (updates.hasOwnProperty(key2)) {
        if (Array.isArray(updates[key2])) {
          newLines.push(`${key2}: [${updates[key2].join(", ")}]`);
        } else {
          newLines.push(`${key2}: ${updates[key2]}`);
        }
      } else {
        newLines.push(line);
      }
...
// src/components/PostDetails.svelte
var root4 = from_html(`<div class="callout" data-callout="info"><div class="callout-title"><div class="callout-title-inner">DRAFT</div></div> <div class="callout-content">This post hasn't been published yet</div></div>`);
var root_12 = from_html(`<div class="callout" data-callout="success"><div class="callout-title"><div class="callout-title-inner">PUBLISHED</div></div> <div class="callout-content">This post is live</div></div>`);
var root_2 = from_html(`<button class="mod-cta svelte-6e2kf4">Publish</button>`);
var root_3 = from_html(`<button class="mod-cta svelte-6e2kf4">Unpublish</button>`);
var root_4 = from_html(`<div class="properties-view svelte-6e2kf4"><!> <h4 class="svelte-6e2kf4">Properties</h4> <div class="form-control svelte-6e2kf4"><label for="title">Title</label> <input name="title" class="svelte-6e2kf4"/></div> <div class="form-control svelte-6e2kf4"><label for="date">Date</label> <input name="date" type="date" class="svelte-6e2kf4"/></div> <hr class="svelte-6e2kf4"/> <div class="button-group svelte-6e2kf4"><div><button class="danger svelte-6e2kf4">Delete</button></div> <div><button class="svelte-6e2kf4">Save</button> <!></div></div> <!></div>`);
var $$css4 = {
  hash: "svelte-6e2kf4",
  code: ".properties-view.svelte-6e2kf4 {display:flex;flex-direction:column;align-items:stretch;gap:1rem;}h4.svelte-6e2kf4 {font-size:0.85em;font-weight:600;text-transform:uppercase;letter-spacing:0.05em;color:var(--text-muted);margin:0;}.form-control.svelte-6e2kf4 {display:flex;flex-direction:column;align-items:stretch;gap:0.5rem;}input.svelte-6e2kf4 {width:100%;padding:10px 12px;border:1px solid var(--background-modifier-border);border-radius:6px;background:var(--background-primary);color:var(--text-normal);font-size:0.95em;transition:border-color 0.15s ease;}input.svelte-6e2kf4:focus {outline:none;border-color:var(--interactive-accent);}input.svelte-6e2kf4::placeholder {color:var(--text-faint);}hr.svelte-6e2kf4 {margin:0.5rem;}.button-group.svelte-6e2kf4 {display:flex;justify-content:space-between;}button.svelte-6e2kf4 {cursor:pointer;}button.danger.svelte-6e2kf4 {color:var(--text-error);}"
};
function PostDetails($$anchor, $$props) {
  append_styles($$anchor, $$css4);
  let statefulTitle = state(proxy($$props.title));
  let statefulDate = state(proxy($$props.date));
  ...
  var node_1 = sibling(button_1, 2);
  {
    var consequent_1 = ($$anchor2) => {
      var button_2 = root_2();
      delegated("click", button_2, () => handleClick($$props.onPublish));
      append($$anchor2, button_2);
    };
    var alternate_1 = ($$anchor2) => {
      var button_3 = root_3();
      delegated("click", button_3, () => handleClick($$props.onUnpublish));
  ...
  var node_2 = sibling(div_5, 2);
  {
    var consequent_2 = ($$anchor2) => {
      var text2 = text("Busy doing the thing...");
  ...
  reset(div);
  bind_value(input, () => get2(statefulTitle), ($$value) => set(statefulTitle, $$value));
  bind_value(input_1, () => get2(statefulDate), ($$value) => set(statefulDate, $$value));
  delegated("click", button, () => handleClick($$props.onDelete));
  delegated("click", button_1, () => handleClick($$props.onSave, get2(statefulTitle), get2(statefulDate)));
  append($$anchor, div);
}
delegate(["click"]);

// src/views/PostDetailsView.ts
var VIEW_TYPE_POST_DETAILS = "jequill-post-details-view";
var PostDetailsView = class extends import_obsidian3.ItemView {
  constructor(leaf) {
    super(leaf);
  ...
  async renderView() {
    ...
    this.properties = mount(PostDetails, {
      ...
      props: {
        ...
        date: (_a5 = frontmatter.date) == null ? void 0 : _a5.split(" ")[0],
  ...
  async savePost(newTitle, newDate, onNotify) {
    ...
    try {
      ...
      new import_obsidian3.Notice("Post updated");
    } catch (error) {
      console.error("Failed to save post:", error);
      new import_obsidian3.Notice("Failed to save post");
    } finally {
      onNotify();
    }
  }
...
var JequillPlugin = class extends import_obsidian4.Plugin {
  async loadSettings() {
  ...
  async onload() {
    ...
    this.registerEvent(
      this.app.workspace.on("jequill:settings-changed", () => {
        this.renderLayout();
      })
    );
    this.addCommand({
  ...
  renderLayout() {
    var _a5;
    if ((_a5 = this.settings) == null ? void 0 : _a5.enableMinimalWorkspace) {
  ...
  async activatePostsView() {
    ...
    if (leaves.length > 0) {
      ...
      await (leaf == null ? void 0 : leaf.setViewState({ type: VIEW_TYPE_POSTS, active: true }));
    }
    if (leaf) {
  ...
  async activatePropertiesView() {
    ...
    if (leaves.length > 0) {
      ...
      await (leaf == null ? void 0 : leaf.setViewState({ type: VIEW_TYPE_POST_DETAILS, active: true }));
    }
    if (leaf) {
      workspace.revealLeaf(leaf);
    }
